 ...
 */
class ItemPools extends AbstractRegistryPattern implements CacheItemPoolInterface
{
    /**
     * ItemPools::__construct
     *
    ...
    public function createItemPool ( $poolOffset, Registries\Config $poolConfig )
    {
        ...
        if ( class_exists( $adapterClassName ) ) {
            ...
            $this->register( $poolOffset, $adapter );
        }
    }
     ...
     * @param string $poolOffset
     *
     * @return AbstractItemPool
     */
    public function &__get ( $poolOffset )
    {
        return parent::__get( $poolOffset );
    }
